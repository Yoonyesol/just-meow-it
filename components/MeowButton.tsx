...
const MeowButton = () => {
    ...
    return (
        <div className="text-center px-3">
            {isLoading && <Loader />}
            {showBubble && (
                <div className="animate-fadeInOut absolute top-[130px] left-1/2 transform -translate-x-1/2 mx-0 rounded-lg border border-gray-300 bg-white px-4 py-2 text-black shadow-lg">
